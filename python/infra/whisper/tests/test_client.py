...
@pytest.mark.asyncio
async def test_transcribe_audio_with_custom_options() -> None:
...
@pytest.mark.asyncio
async def test_transcribe_audio_with_usage_data() -> None:
...
@pytest.mark.asyncio
async def test_transcribe_audio_with_token_usage() -> None:
...
@pytest.mark.asyncio
async def test_transcribe_audio_api_failure() -> None:
...
@pytest.mark.asyncio
async def test_transcribe_audio_pydantic_validation() -> None:
...
@pytest.mark.asyncio
async def test_transcribe_audio_with_dependency_override() -> None:
...
@pytest.mark.asyncio
async def test_transcribe_audio_with_explicit_client_injection() -> None:
