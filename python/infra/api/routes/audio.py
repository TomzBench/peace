...
from python.infra.whisper import TranscriptionResult, open_audio_file_async, transcribe_audio
...
@router.get("/{video_id}", response_model=TranscriptionResult)
async def transcribe_video(video_id: str, settings: SettingsDepClean) -> TranscriptionResult:
