...
# Import routes module for coverage tracking
from python.infra.api.routes import users  # noqa: F401
...
@pytest.mark.asyncio
async def test_update_user_with_password(client: AsyncClient) -> None:
